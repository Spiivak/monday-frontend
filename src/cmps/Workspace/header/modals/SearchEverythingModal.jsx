...
export function SearchEverythingModal({ onClose }) {
  ...
  const handleClickOutside = (event) => {
    ...
    if (
      !modalRef.current ||
      (!modalRef.current.contains(event.target) && !isSearchButton)
    ) {
      onClose()
    }
  }
        ...
        <div className="header flex column">
          ...
          <div className="filter-options flex space-between">
            <div className="right flex align-center gap8">
              <NavLink>
                <button className="btn-txt medium-sec">All</button>
              </NavLink>
              <NavLink>
              ...
              <NavLink>
                <button className="btn-txt medium-sec">Updates</button>
              </NavLink>
              <NavLink>
                <button className="btn-txt medium-sec">Files</button>
              </NavLink>
              <NavLink>
                <button className="btn-txt medium-sec">People</button>
              </NavLink>
              <NavLink>
                <button className="btn-txt medium-sec">Tags</button>
              </NavLink>
            </div>
            <div className="left">
        ...
        <div className="main-content flex wrap a">
          ...
          <div className="card">
            ...
            <div className="content flex">
              <ul className="flex column ">
                <li className="flex align-center gap8 btn-txt medium-sec">
                  <AddSmallIcon /> I'm assigned to
                </li>
                ...
                <li className="flex align-center gap8 btn-txt medium-sec">
                  <ArchiveIcon /> Archived Boards
                </li>
                <li className="flex align-center gap8 btn-txt medium-sec">
                  <MentionIcon /> I was mentioned
                </li>
                <li className="flex align-center gap8 btn-txt medium-sec">
                  <MentionIcon />I was mentioned and didn't reply
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="content flex align-center">
              <ul>
                <li className="flex gap8">
                  <Light /> Here you'll find your recent searches. (Did you
                  know? 93% of the time, people search for the same thing)
                </li>
              </ul>
            </div>
          </div>
          <div className="card">
            ...
            <div className="content flex align-center">
              <ul>
                <li className="flex gap8">
                  <Light /> Use this keyboard shortcut to find boards,
                  dashboards and workspaces faster
                </li>
              </ul>
            </div>
          </div>
