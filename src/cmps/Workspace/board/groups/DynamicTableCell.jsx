...
export function DynamicTableCell({ board, cmp, cmpId, task, onTaskUpdate, group, cmpsOrder }) {
  ...
  switch (cmp) {
    ...
    case 'StatusPicker':
      return <StatusPicker {...{ task, cmpId, handleUpdateTask, cmpsOrder, board, loggedInUser }} />

    case 'MemberPicker':
      return <MemberPicker {...{ task, cmpId, handleUpdateTask, cmpsOrder, loggedInUser }} />

    case 'DatePicker':
      return <DatePickerC {...{ task, cmpId, handleUpdateTask, cmpsOrder, loggedInUser }} />

    case 'DescriptionPicker':
      return <DescriptionPicker {...{ task, cmpId, handleUpdateTask, cmpsOrder, loggedInUser }} />

    case 'TimelinePicker':
      return <TimelinePicker {...{ task, cmpId, handleUpdateTask, group, cmpsOrder, loggedInUser }} />
