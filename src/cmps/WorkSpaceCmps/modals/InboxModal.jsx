    ...
    <>
      ...
      <div className="inbox-modal flex">
        ...
        <div className="inbox-aside">
          <div className="inbox-aside-header">
            <div className="inbox-aside-title">
              <h2>Update feed <span>(Inbox)</span></h2>
            </div>
          ...
          <div className="inbox-aside-footer">
            ...
            <div className="inbox-aside-footer-content">
              <div className="tab-container flex space-between">
                <button className='btn-txt medium-sec'>All boards in my feed </button>
              ...
              <div className="tab-container flex space-between">
                ...
                <div className="post-count">
                  <span>1</span>
                  <span className='menu-icon'><ContextBtn type={"row"} onDeleteRow={() => { }} /></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="aside-main">
          <div className="inbox-aside-main-header">
            <div className="header flex space-between">
              <div className="tabs flex">
                <NavLink to="workspace" className='btn-txt medium-sec flex align-center gap8'>All Updates</NavLink>
                <NavLink to="workspace1" className='btn-txt medium-sec flex align-center gap8'><MentionIcon />I was mentioned</NavLink>
                <NavLink to="workspace2" className='btn-txt medium-sec flex align-center gap8'><BookmarkIcon />Bookmarked</NavLink>
                <NavLink to="workspace4" className='btn-txt medium-sec flex align-center gap8'><WorkIcon />All account updates</NavLink>
              </div>
              <div className="header-actions">
                <button className='btn-txt medium-sec flex gap8 align-center'><FeedbackIcon /> Send feedback</button>
                <button onClick={onClose} className='relative btn-icon small-transparent' style={{ top: '-32px', right: '16px' }}><CloseIcon /></button>
              </div>
            </div>
          </div>
            ...
            <div className="inbox-title-actions">
              <div className="action-holder flex space-between">
                ...
                <div className="mark-all-btn">
                  <button className='btn-txt medium-sec flex gap8' disabled={!readUpdates}>
                    <DoubleCheckIcon/>
          ...
          {!readUpdates && <div className="no-unread-updates flex column align-center justify-center">
