...
export function TaskDetails() {
  ...
  const handleClickOutside = (event) => {
    const isTaskDetailsButton = event.target.closest('[data-task-details="true"]');
    if (!modalRef.current || (!modalRef.current.contains(event.target) && !isTaskDetailsButton)) {
      deactivateTask()
    }
  }
      ...
      <div className="task-header flex align-center space-between">
        ...
        <div className="header-actions flex align-center">
          <div className="members-list flex align-center">
            <picture className='flex'><img src={Frame} alt="" /></picture>
            <picture className='flex'><img src={Frame} alt="" /></picture>
          </div>
      ...
      <div className="task-header-tabs flex space-between">
        <div className="task-tabs quick-filters">
          ...
          <div className="add-view flex align-center">
            <button className='btn-icon small-transparent'><AddIcon/></button>
          </div>
      </div>
    </div>
  );
